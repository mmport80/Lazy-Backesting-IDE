...
function Graph(){
        ...
        */
        ...
        function update(allReturns){
                ...
                var s2 = '<script\>"use strict";var d=new Graph();var data ='+JSON.stringify(datax)+';d.draw(data,false,'+JSON.stringify(graphTimeSeries)+');</script\>';                        
                //(importString+s2);
                
                console.log("datax");
                console.log(datax);
                                
                document.getElementById('codex') != null ? document.getElementById('codex').value = (importString+s2) : null;
